...
- **Immediate warning:** Issue an immediate warning to prevent people from clicking on any links related to scams.
- **The data source is always fresh:** data is updated from various communities to ensure it is always up-to-date.
