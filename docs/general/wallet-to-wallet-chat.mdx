...
On-chain transactions and asset ownership provide transparency about any person. You can connect and interact confidently with creators, builders, and holders by looking at the assets they hold and the transactions they did. No more wasted time worrying and verifying messages to strangers as before.
...
### Detox your inbox with token-gated
...
### Message sent from "your_name.eth”
...
![](../../static/img/general/wallet-to-wallet/wallet-to-wallet-token-ens-name.png)

### Shoot a DM to the NFT owner
