...
Getting started with Buidler is now easier with the integration of [Web3Auth](https://web3auth.io/). You can now log in to your Buidler account using your existing social accounts like Google, Facebook, Apple, and Discord.
