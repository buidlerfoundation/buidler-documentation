...
If you already have a wallet, you can import it to Buidler using your seed phrase or private key. Download the Buidler app on [iOS](https://buidler.app/download/ios) or [macOS](https://buidler.app/download/mac) and follow the instructions to import your wallet.

Buidler enables you to keep using your wallet details and assets, such as addresses, ENS names, cryptocurrencies, and NFTs. In other words, you can use Buidler as your crypto wallet to store, send, and receive assets.
